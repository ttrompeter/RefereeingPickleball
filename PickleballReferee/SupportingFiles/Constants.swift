...
struct Constants {
    ...
    // Light Gray
    static var CITY_LIGHTS = Color(red: 223/255, green: 230/255, blue: 233/255)
    // Light Silver Gray
    static var CLOUDS = Color(red: 236/255, green: 240/255, blue: 241/255)
    // Medium Gray
    static var CONCRETE = Color(red: 149/255, green: 165/255, blue: 166/255)
    // Bright Red
    ...
    // Black
    static var DRACULA_ORCHID = Color(red: 45/255, green: 52/255, blue: 54/255)
    // Medoium Blue
    static var ELECTRON_BLUE = Color(red: 9/255, green: 132/255, blue: 227/255)
    // Bright Green
    static var EMERALD = Color(red: 46/255, green: 204/255, blue: 113/255)
    // Bright Blue
    ...
    // Almost Black
    static var MIDNIGHT_BLUE = Color(red: 44/255, green: 62/255, blue: 80/255)
    // Medium Green
    ...
    // Medium Gray
    static var SOOTHING_BREEZE = Color(red: 178/255, green: 190/255, blue: 195/255)
    // Light Yellow
    static var SOUR_LEMON = Color(red: 255/255, green: 234/255, blue: 167/255)
    // Very Dark Gray
    static var WET_ASPHALT = Color(red: 52/255, green: 73/255, blue: 94/255)
    // Just What It Says
