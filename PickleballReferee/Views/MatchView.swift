...
struct MatchView: View {
    ...
    var body: some View {
        VStack {
            ...
            .padding(.top, 40)
            NavigationLink (destination: MatchView(match: Match()), isActive: $startNewMatch) { }
            //Spacer()
                        ...
                        HStack {
                            ...
                            HStack {
                                if scoresheetManager.playerInitials.isEmpty {
                                    ...
                                    //.autocapitalization(.allCharacters)  /Does not work with number pad
                                        .frame(width: 60)
                                        .foregroundColor(Constants.POMAGRANATE)
